  ...
  return (
    <div className="bg-[#faf9f7] min-h-screen">
      ...
      <div className="relative h-[75vh] w-full">
        ...
        <div className="absolute bottom-24 left-6 right-6 max-w-3xl">
          ...
          <p className="mt-3 text-lg text-white/90 max-w-xl">
            Comprehensive fashion design training covering garment construction,
            pattern making, stitching, and creative design techniques.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 mt-4 relative z-10">
        <div
          className=" bg-[#faf8f3] border border-[#e8e2d8] rounded-[32px] 
        p-8  shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
        >
          {/* Benefits */}
          <ul className="space-y-3 text-gray-800 text-base">
            <li>✔ Learn garment construction and stitching techniques</li>
            <li>✔ Understand pattern making fundamentals</li>
            <li>✔ Build practical fashion design skills</li>
            <li>✔ Suitable for beginners and aspiring designers</li>
          </ul>
