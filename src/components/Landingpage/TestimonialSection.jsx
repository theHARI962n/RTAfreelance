export default function TestimonialsSection() {
    ...
    return (
      <section id="testimonials" className="py-28 px-6 bg-[#fffef9] mt-20 md:mt-0">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-[#faf8f3] shadow p-6 rounded-xl text-center hover:shadow-lg transition">
